...
public class TreeMap01 {
       /*
        ...
        4)TreeMap'lerin "key" lerinde "null" kullanilamaz ama "value" larda
          istediginiz kadar kullanabilirsiniz
     */

    public static void main(String[] args) {

        long one = System.nanoTime();//TreeMap: 758300
        ...
        long two = System.nanoTime();//HashMap: 54000
        ...
        long three = System.nanoTime();//HashMap --> TreeMap: 48300
        ...
        System.out.println("TreeMap: " + (two-one) ); //  HashMap --> TreeMap: 48300
        System.out.println("HashMap: " + (three-two) );// HashMap: 54000
        System.out.println("HashMap --> TreeMap: " + (four - three) );//TreeMap: 758300
    }//main
}
