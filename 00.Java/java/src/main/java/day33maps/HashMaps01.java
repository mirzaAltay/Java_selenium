...
public class HashMaps01 {
        ...
        2) "USA = 400,000,000" data'sinin "USA" kismi "key" olarak adlandirilir ve
           "key" ler "unique" dir.
    ...
    public static void main(String[] args) {
        ...
        if(salaries.keySet().contains(teacherName)) {
            ...
            salaries.putIfAbsent(teacherName, 11000);//yoksa ekle
        }
        ...
        //getOrDefault() olan "key" lerin degerini verir, olmayan "key" ler icin
        // de sizin ikinci parametreye yazdiginiz degeri verir.
        Integer r = hm.getOrDefault("Bhutan", 0);//Bhutan varsa degerini verir yoksa
        // defaultValiue ya ne verdiyseniz verir
        ...
        //entrySet(); method'unu kullandiginizda elde ettiginiz Set'in elemanlari
        // "Map.Entry<String,Integer>" seklinde bir Map olur.
