...
public class C01_Exceptions {
    ...
    public static void main(String[] args) throws IOException {
        ...
        read() ==> Tas'teki Datalari karakter karakter okuyor ve getiriyor.
        Okuyacak hic bir data kalmadiginda -1 donduruyor
        ...
        try {
            while((i = fis.read()) != -1 ){//char'i int konteyner int i ye koyarsaniz ascii dondurur
