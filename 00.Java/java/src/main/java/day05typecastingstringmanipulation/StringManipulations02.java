package main.java.day05typecastingstringmanipulation;
...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        //Note: "Hicbir sey" char data type'inda yok bu yuzden replace() method'u kullanarak silme islemi yaparsaniz
