...
public class Lambda01 {
    ...
    /*
        1)Lambda "Functional==(Method Demek) programming" dir, digeri "Structured Programming"
        ...
        "Lambda" list'i "stream" e cevirir öyle calisir.
        "filter()" filtrelemek icin kullanilir.
        "map()" u var olan elemani DEGISTIRMEK icin kullanilir.
        "distinct()" u tekrarli elemanlari sadece bir kere gosterir ve tekrarsizlari
        olduklari kadar gosterir.
    ...
    */
    ...
    //  Bir list'teki elemanlari ayni satirda aralarina bosluk koyarak
    //  yazdiran method'u olusturunuz.(Structured == Klasik)
    ...
    //2)Create a method to print the list elements on the console in the
    // same line with a space between two consecutive elements.(Functional)

    //  Bir list'teki elemanlari ayni satirda aralarina bosluk koyarak yazdiran
    ...
    //3)Create a method to print the "even" list elements on the console
    //  in the same line with a space between two consecutive elements.(Structured)
    //  Bir list'teki cift elemanlari ayni satirda aralarina bosluk koyarak
    ...
    //4)Create a method to print the "even" list elements on the console in the
    //  same line with a space between two consecutive elements.(Functional)
    //  Bir list'teki cift elemanlari ayni satirda aralarina bosluk koyarak yazdiran
    //  method'u olusturunuz.(Functional)
    ...
    public static void printSquareOfOddElements(List<Integer> nums){
        nums.
                stream().
                filter(t->t%2!=0).
                map(t->t*t).//varolan elemani degistirir
                forEach(t-> System.out.print(t + " "));
    }

    //6)Create a method to print the "cube" of "distinct" "odd" list elements
    ...
    public static void printCubeOfDistinctOddElements(List<Integer> nums){
        nums.
                stream().//datalari akisa sundum
                distinct().//tekrarsiz olanlari sec
                filter(t->t%2!=0).//filtreleme yaptim
                map(t->t*t*t).//donusturdum
                forEach(t-> System.out.print(t + " "));
    }

    //7)Create a method to calculate the "sum" of the "squares" of "distinct" "even" elements
    //"FARKLI" "CIFT " ELEMANLARIN "karelerinin" "toplamını" hesaplamak için bir yöntem oluşturun
