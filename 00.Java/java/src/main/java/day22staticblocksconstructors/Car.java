...
public class Car {
      ...
      /*
        ...
        Ama bu constructor gozle gorulmez, gozle gorulmeyen otomatik olarak
        Java tarafindan verilen bu constructor'lara
        "default constructor" denir.
        "default constructor"lar "Car(){ }" seklindedir
        Siz kendi constructor'inizi olusturdugunuzda
        Java default constructor'i siler.

        Bir Class'da farkli parametreler kullanarak istediginiz kadar
        constructor olusturabilirsiniz.

        Farkli constructor'lar sayesinde bir class'dan farkli farkli
