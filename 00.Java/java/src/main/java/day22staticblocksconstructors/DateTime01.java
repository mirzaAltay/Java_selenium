package main.java.day22staticblocksconstructors;
...
public class DateTime01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(myDate.getTime());// 1673123407075 ==>
        // 1 Ocak 1970(digital tarih baslangici) den su ana kadar ki mili saniye miktari
        //milisaniye unique bir degerdir.
        // Bu milisaniyeyi bir daha yakalayamayiz.Bu yuzden database'e bilgi eklerken milisaniye kullanilir

        //Icinde bulundugumuz an(current time) nasil alinir?
        System.out.println(LocalDate.now());// 2023-01-07 simdiki tarih

        System.out.println(LocalTime.now());// 15:36:10.482639 simdiki zaman saat dk saniye milisaniye
        ...
        System.out.println(LocalTime.now().getHour() + ":" + LocalTime.now().getMinute());// 16:2 int getMinute
        // o yuzden 02 degil 2 verdi
